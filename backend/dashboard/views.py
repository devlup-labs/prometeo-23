...
def get_pass_excel(request):
    ...
    worksheet.write(0, 4, "Aadhar Number")
    worksheet.write(0, 5, "Date of Birth")
    worksheet.write(0, 6,"Address")
    worksheet.write(0, 7,"CA Referral Code")
    ...
    for passtype in passtypes:
        ...
        worksheet.write(row, 2, passtype.user.gender)
        worksheet.write(row, 3, passtype.pass_type)
        worksheet.write(row, 4, passtype.aadhar_card)
        worksheet.write(row, 5, passtype.dob)
        worksheet.write(row, 6, passtype.address)
        worksheet.write(row, 7, passtype.user.referral_code)
        row = row + 1
    workbook.close()
