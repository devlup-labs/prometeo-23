...
class Event(models.Model):
    ...
    sponsor_image1 = models.ImageField(upload_to="images/", blank=True, verbose_name="Sponser Image 1(upload rectangular images)")
...
class Gallery(models.Model):
    ...
    image = models.ImageField(upload_to="gallery/images/", null=True, blank=True, verbose_name="Image file")
