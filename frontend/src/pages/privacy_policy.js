        ...
        <FadeIn duration={500}>
            <div className="pp-container">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            refers to Prometeo, IIT Jodhpur, N.H. 62, Nagaur
                            Road, Jodhpur 342030 (Rajasthan).
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Prometeo,
                            accessible from{" "}
                            <a
                                href="https://prometeo.in/"
                ...
                <p>
                    ...
                    contact us at{" "}
                    <a href="mailto:pr@prometeo.in">pr@prometeo.in</a>
                </p>
            </div>
        </FadeIn>
    );
