...
//                     <div className="login-container-left" style={{
//                         // backgroundImage: `url(${loginImg})`,
//                     }}>
//                         <img src={loginImg} alt="Login Image" />
//                     </div>
//                     <div className='login-container-right'>
//                         <div className="login-container-right-title">
//                             Login
//                         </div>
...
//                                 <input type="submit" value="Log In Using Google" id="login-form-submit" className='form-google-signin' />
//                                 <img src="https://cdn-teams-slug.flaticon.com/google.jpg" className="google-img"></img>
// 							</div>
//                         </form>
