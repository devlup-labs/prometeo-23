    ...
    return (
        <FadeIn duration={500}>
            <div className="tnc-container">
                ...
                <p>Welcome to Prometeo!</p>

                <p>
                    These terms and conditions outline the rules and regulations
                    for the use of Prometeo's Website, located at
                    https://prometeo.in/.
                </p>

                <p>
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use Prometeo if you do
                ...
                <p>
                    We employ the use of cookies. By accessing Prometeo, you
                    agreed to use cookies in agreement with the Prometeo's
                    Privacy Policy.{" "}
                </p>
                ...
                <p>
                    Unless otherwise stated, Prometeo and/or its licensors own
                    the intellectual property rights for all material on
                    Prometeo. All intellectual property rights are reserved. You
                    may access this from Prometeo for your own personal use
                    subjected to restrictions set in these terms and conditions.
                </p>

                <p>You must not:</p>
                <ul>
                    <li>Republish material from Prometeo</li>
                    <li>Sell, rent or sub-license material from Prometeo</li>
                    <li>Reproduce, duplicate or copy material from Prometeo</li>
                    <li>Redistribute content from Prometeo</li>
                </ul>
                ...
                <p>
                    Prometeo reserves the right to monitor all Comments and to
                ...
                <p>
                    You hereby grant Prometeo a non-exclusive license to use,
                ...
                <p>
                    ...
                    compensates the absence of Prometeo; and (d) the link is in
                ...
                <p>
                    ...
                    inform us by sending an e-mail to Prometeo. Please include
                ...
                <p>
                    No use of Prometeo's logo or other artwork will be allowed
