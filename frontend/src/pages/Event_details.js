              ...
              <div className="event-details__sponsors_images">
                <div className="event_sponsors_image1">
                  <img
                    ...
                    src="https://drive.google.com/uc?export=view&id=1Abgp87RA3sFTccFsFSvD2oK3U6T75q6v"
                    //   title={sponsor.name}
                    alt="Sponsor Image"
                    //   key={sponsor.id}
                  />
                  <img
                    // src="../assets/logo_sponsors/Devfolio_Logo-Colored.png"
                    src="https://drive.google.com/uc?export=view&id=1DF_dqFpCEF4RFyL5sYe8uY4HhLAKsrfD"
                    //   title={sponsor.name}
                    alt="Sponsor Image"
                    //   key={sponsor.id}
                  />
                ...
                <div className="event_sponsors_image2">
                  ...
                  <img
                    // src="../assets/logo_sponsors/Devfolio_Logo-Colored.png"
                    src="https://drive.google.com/uc?export=view&id=1PEvbvpK3bl_Yxd4NvkmatFvwlXVwpDFO"
                    //   title={sponsor.name}
                    alt="Sponsor Image"
                    //   key={sponsor.id}
                  />
                  <img
                    // src="../assets/logo_sponsors/Devfolio_Logo-Colored.png"
                    src="https://drive.google.com/uc?export=view&id=1SuX0_zbGIgraGNEliYry97XdZQKHlf1C"
                    //   title={sponsor.name}
                    alt="Sponsor Image"
                    //   key={sponsor.id}
                  />
