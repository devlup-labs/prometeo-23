                    ...
                    <div id="dashboard-personalDetails">
                        ...
                        <div id="dashboard-personalDetails-content">
                            <div className="dashboard-personalDetails-content-title">
                                Name: <span className="dashboard-personalDetails-content-value">{user.username.replace('_', ' ')}</span>
                            </div>
                            <div className="dashboard-personalDetails-content-title">
                            ...
                            </div>
                            {
                                userData.contact && (
                                    <div className="dashboard-personalDetails-content-title">
                                        Phone: <span className="dashboard-personalDetails-content-value">{userData.contact}</span>
                                    </div>
                                )
                            }
                        </div>
                                ...
                                <div id="dashboard-caDetails">
                                    ...
                                    <div id="dashboard-caDetails-content">
                                        <div className="dashboard-caDetails-content-title">
                                            Invite code: <span className="dashboard-caDetails-content-value">{userData.invite_referral}</span>
                                            <svg className="fa fa-copy" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                                onClick={() => {
